...
type (
	friendRequestsModel interface {
		...
		FindByReqUidAndUserId(ctx context.Context, rid string, uid string) (*FriendRequests, error)
...
func (m *defaultFriendRequestsModel) FindByReqUidAndUserId(ctx context.Context, rid string, uid string) (*FriendRequests, error) {
